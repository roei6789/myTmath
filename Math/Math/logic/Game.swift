...
//            self.currentWorlds = [:]
    ...
    func initWorlds (){
        let world_1 = Worlds.init(ID: 1, Name: "חידות הנדסיות", Array_Questions: build_QG_Array(), picture: "magicSqures")
        
         let world_2 = Worlds.init(ID: 2, Name: "חשוב וחשב", Array_Questions: build_QTS_Array(), picture: "Think_solve.png")
